...
USE read_jules_namelists_mod, ONLY:                                           &
    ...
    read_jules_elevate,                                                       &
    read_urban_switches,   read_urban2t_param,    read_jules_vegetation,      &
    read_jules_hydrology,  read_jules_radiation,  read_jules_sea_seaice,      &
    read_jules_snow,       read_jules_surface_types,                          &
    read_jules_soil,       read_jules_surface, read_lsm_switches
...
CALL read_urban_switches(shared_unit)
...
IF (call_type == "UM") THEN
  ...
  CALL read_urban2t_param(atmoscntl_unit)
  !CABLE_LSM
  CALL read_lsm_switches(atmoscntl_unit)
END IF
