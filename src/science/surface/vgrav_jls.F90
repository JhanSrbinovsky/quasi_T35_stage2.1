...
REAL vstokes( tdims%i_start:tdims%i_end,tdims%j_start:tdims%j_end,nlevs)
  !OUT sedimentation velocity
REAL etaa(    tdims%i_start:tdims%i_end,tdims%j_start:tdims%j_end,nlevs)
  !OUT viscosity of air
REAL ccf(     tdims%i_start:tdims%i_end,tdims%j_start:tdims%j_end,nlevs)
