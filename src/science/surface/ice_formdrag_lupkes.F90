...
!         method of discretization of the bottom layer.
          IF (i_modiscopt == on) THEN
            cd_sea = (vkman / ALOG(1.0 + z1_tq_top_sea(i,j) / &
                                   z0m_sea(i,j)))**2
            cd_int = (vkman / ALOG(1.0 + z1_tq_top_sea(i,j) / &
                                   z0m_ice(i,j)))**2
          ELSE
            cd_sea = (vkman / ALOG(1.0 + z1_tq_sea(i,j) / &
                                   z0m_sea(i,j)))**2
            cd_int = (vkman / ALOG(1.0 + z1_tq_sea(i,j) / &
                                   z0m_ice(i,j)))**2
          ENDIF
        ENDIF
