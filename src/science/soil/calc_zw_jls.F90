...
REAL                                                                          &
 zw_old                                                                       &
            ! WORK zw from last timestep/iteration.
,fn                                                                           &
            ! WORK fn calc in Newton-Raphson iteration.
,dfn                                                                          &
            ! WORK derivative of fn.
,zwest                                                                        &
            ! WORK
,smd                                                                          &
...
!                     !      (negative).
,diffinter  ! WORK Difference between zw estimates between
!                     !      iterations.
